          ...
          <button
            ...
            className={`flex w-full items-center px-2 py-2 text-sm font-medium rounded-md ${
              isActive
                ...
                : "text-gray-600 hover:bg-light-velvet hover:text-lavender"
            }`}
          >
                ...
                <Link
                  ...
                  className={`block px-2 py-2 text-sm rounded-md ${
                    location.pathname === child.href
                      ? "bg-light-velvet text-lavender font-medium"
                      : "text-gray-600 hover:bg-light-velvet hover:text-lavender"
                  }`}
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
        <div className="flex flex-col flex-grow bg-white border-r overflow-y-auto">
          <div className="flex items-center h-16 px-6 border-b">
            <PackageSearchIcon className="h-8 w-8 text-velvet mr-3" />
            <h1 className="text-xl font-bold text-velvet font-brand text-center">
              BizLenZ
            </h1>
          </div>
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        {/* Top navigation */}
        <div className="sticky top-0 z-10  shadow-sm border-b">
            ...
            <div className="flex items-center space-x-4 ml-auto">
              <div className="flex items-center space-x-2">
                <div className="text-sm">
                  <div className="font-medium text-dark-velvet">
                    {user?.name}
                  </div>
                  <div className="text-velvet-500">
                    {user?.roles.join(", ")}
                  </div>
                </div>
                <button
                  onClick={handleLogout}
                  className="p-2 text-velvet-400 hover:text-velvet-500"
                  title="Logout"
                >
